...
srun -N 1 --gres=gpu:1 ./run "/gpu_trainee/final-project/modelbin/gpt-oss-20b.bin" -m getp -i evaluation/input.txt -o evaluation/submission/output_20b_token_ids.txt
