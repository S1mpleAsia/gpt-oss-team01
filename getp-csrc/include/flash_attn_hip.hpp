...
void single_query_attn_flash_batched_quantize(
  ...
  int num_query_heads, int kv_mul, int kv_dim, int seq_len,
  int sliding_window,  // 0 means disabled
  int pos, long long layer_offset, bool q_to_device, bool k_cache_to_device, bool v_cache_to_device,
