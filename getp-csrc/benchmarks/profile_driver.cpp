...
int main() {
  ...
  HIP_CHECK(
    hipMemcpy(&h_load_cycles, d_load_cycles, sizeof(unsigned long long), hipMemcpyDeviceToHost));
  HIP_CHECK(
    hipMemcpy(&h_comp_cycles, d_comp_cycles, sizeof(unsigned long long), hipMemcpyDeviceToHost));
